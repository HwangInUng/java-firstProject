...
import surfing.gui.chart.Combine;
...
public class MainPanel extends Page {
	...
	// 상단 분야별 현황 필드
	MainTopPanel p_total, p_training, p_sales;
	MainLabel la_total, la_training, la_sales;
	JLabel la_totalTraining, la_totalSales;
	Pie2 training_pie, sales_pie;
