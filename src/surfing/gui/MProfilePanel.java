...
public class MProfilePanel extends Page implements ActionListener {
	...
	String dir = "/Users/inung/eclipse-workspace/SurfingProject/src/res/profile/";

	// 상단 유저이름 필드
	JLabel la_user;

	// 프로필 상세정보 필드
	JPanel p_profile, p_info;
	JLabel la_image;
	Image image;
	String[] m_labelName = { "회원 이름 : ", "SNS 아이디 : ", "서핑 베이스 : ", "보드 브랜드 : ", "보드 가격 : ", "서핑 경력 : " };
	JLabel[] m_labelList = new JLabel[6];
	JTextField[] m_textFieldList = new JTextField[6];

	// 하단 버튼필드
	JButton bt_save, bt_back;
