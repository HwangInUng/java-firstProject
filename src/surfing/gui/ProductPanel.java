...
public class ProductPanel extends Page implements ActionListener {
	...
	// 상단 검색필드
	JComboBox<String> box_productCategory;
	String[] categoryName = { "상위구분", "하위구분", "상품" };
	JTextField t_productSearch;
	JButton bt_productSearch;
	JButton bt_allList;
	...
	// 하단 수정 및 등록 필드
	JTextField t_productName, t_productBrand, t_productPrice, t_stock;
	JButton bt_productRegist, bt_productEdit, bt_productDel;
