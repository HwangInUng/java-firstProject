...
public class MemberPanel extends Page implements ActionListener {
	// db연동
	public SurfMemberDAO surfMemberDAO;

	// 상단 검색필드
	private String[] categoryName = { "회원번호", "ID", "이름" };
	private JComboBox<String> box_memberCategory;
	private JTextField t_memberSearch;
	private JButton bt_memberSearch;
	...
	// 하단 버튼 필드
	private JButton bt_profile, bt_memberDel;

	// 상세보기 페이지 구현을 위하여 멤버로 보유
	private MProfilePanel mProfilePanel;

	// 현재 선택한 DTO를 멤버로 보유
	public SurfMember currentMember;
