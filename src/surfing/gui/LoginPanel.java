...
public class LoginPanel extends Page implements ActionListener {
	// 로그인 화면 구성
	JPanel p_loginInfo;
	JLabel la_logo, la_id, la_pass;
	JTextField t_id;
	JPasswordField t_pass;
	JButton bt_login, bt_edit, bt_regist;

	// 로고 이미지
	Image logo;
	String dir = "/Users/inung/eclipse-workspace/SurfingProject/src/res/logo/";
